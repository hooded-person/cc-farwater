...
local function setSetting(name, setTemplate, setType, setConditions)
    ...
    -- if type STRING conditions: options(array(string)) or regex(string)
    if setType == "string" and type(setConditions) == "table" then
    ...
    while true do
        ...
        elseif setType == "string" and type(setConditions) == "table" then
            local optionTable = {}
        ...
        elseif setType == "string" and type(setConditions) == "function" then
            success = setConditions(input)
        end
        if success then
            if setType == "table" then
